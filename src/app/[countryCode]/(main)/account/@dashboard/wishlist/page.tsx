...
export default function WishlistPage() {
  ...
  console.log("[WishlistPage] Rendering. Retrieving Customer:", retrievingCustomer, "Loading:", loading);
  console.log("[WishlistPage] Wishlist object from context:", wishlist);
  console.log("[WishlistPage] wishlistItems array from context:", wishlistItems);
  console.log("[WishlistPage] Error from context:", error);
  ...
  if (!customer) {
    // Предлагаем войти
    // Этот блок по идее не должен показываться, т.к. страница в слоте @dashboard
