              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center h-full p-3 pt-6">
                    <div className={`font-bold mb-0.5 ${isMobile ? 'text-sm' : 'text-base'}`}>
                      {value}
                    </div>
        ...
        <Dialog as="div" className="relative z-[9999]" onClose={setIsOpen}>
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className={`pointer-events-none fixed inset-y-0 ${isMobile ? 'inset-x-0' : 'right-0'} flex max-w-full`}>
                <Transition.Child
                  as={Fragment}
                ...
                >
                  <Dialog.Panel className={`pointer-events-auto ${isMobile ? 'w-screen h-screen' : 'w-screen max-w-[765px]'}`}>
                      ...
                      {isMobile ? (
                        ...
                        <>
                          ...
                          <div className="flex-1 overflow-y-auto pb-20">
                            {/* Картинка и информация о товаре */}
                            <div className="flex p-4 gap-4">
                              ...
                              <div className="flex-1 flex flex-col justify-center">
                                {/* Тип товара */}
                                {product.type?.value && (
                                  <div className="text-gray-500 mb-1 uppercase" style={{
                                    fontSize: "9px",
                                    fontWeight: 500,
                                    letterSpacing: "1.4px",
                                    lineHeight: 1.5,
                                ...
                                {/* Название товара */}
                                <h3 className="text-black font-medium leading-tight uppercase mb-1" style={{
                                  fontSize: "18px",
                                  fontWeight: 500,
                                  letterSpacing: "-0.4px",
                                  lineHeight: 1.1
                                ...
                                {/* Подзаголовок */}
                                {product.subtitle && (
                                  <div className="text-black font-medium leading-tight lowercase" style={{
                                    fontSize: "18px",
                                    fontWeight: 500,
                                    letterSpacing: "-0.4px",
                                    lineHeight: 1.1
